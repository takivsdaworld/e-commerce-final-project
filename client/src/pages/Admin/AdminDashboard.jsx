...
const AdminDashboard = () => {
  ...
  const { data: salesDetail } = useGetSalesByDateQuery();
    ...
    <>
      ...
      <section className="xl:ml-[4rem] md:ml-[0rem]">
        <div className="w-[80%] flex justify-around flex-wrap">
          ...
          <div className="rounded-lg bg-[#1A1A1A] p-5 w-[20rem] mt-5">
            <div className="font-bold rounded-full w-[3rem] bg-[#58D68D] text-center p-3">
              <p className="text-black text-xl">C</p>
            </div>
          ...
          <div className="rounded-lg bg-[#1A1A1A] p-5 w-[20rem] mt-5">
            <div className="font-bold rounded-full w-[3rem] bg-[#A569BD] text-center p-3">
              <p className="text-black text-xl">O</p>
            </div>
