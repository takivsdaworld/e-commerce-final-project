  ...
  return (
    <>
      <button
        ...
        className="absolute top-4 left-4 z-[110]"
      >
        <svg
      ...
      {showSidebar && (
        <div
          style={{ zIndex: 100 }}
          className="flex flex-col justify-between p-4 text-white bg-black h-[100vh] w-[15%] fixed"
        ...
        >
          <div className="flex flex-col justify-center space-y-4">
            ...
            >
              ...
              <span className="mt-[3rem]">Favorites</span>
            </Link>
          </div>
