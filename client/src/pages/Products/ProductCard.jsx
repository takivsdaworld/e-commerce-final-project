    ...
    <div className="max-w-sm relative bg-[#1A1A1A] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <section className="relative">
        <Link to={`/product/${p._id}`}>
          <span className="absolute bottom-3 right-3 bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-200">
            {p?.brand}
          </span>
      ...
      <div className="p-5">
        <div className="flex justify-between">
          ...
          <p className="text black font-semibold text-blue-500">
        ...
        <p className="mb-3 font-normal text-[#CFCFCF] dark:text-[#CFCFCF]">
